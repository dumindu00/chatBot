...
const handleFormSubmit = (e) => {
    ...
    setTimeout(() => {
        ...
        const botMsgHTML = `<img src="image.JPG" class="avatar"><p class="message-text">Wait a sec....</p>`;
...
themeToggle.addEventListener("click", () => {
    ...
    // set initial theme form local storage
